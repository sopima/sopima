<div class="page-header">
    <h2>API-Tokens</h2>
    <a href="/settings?tab=tokens&action=create" class="btn btn-primary"><i class="ti ti-plus"></i> Token erstellen</a>
</div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($t['client_name'] ?? 'Alle'); ?></td>
                    ...
                    <td>
                        <span class="badge <?php echo $t['active'] ? 'badge-aktiv' : 'badge-abgelaufen'; ?>">
                            <?php echo $t['active'] ? 'Aktiv' : 'Inaktiv'; ?>
                        </span>
                    </td>
                    ...
                    <td style="white-space:nowrap;">
                        <form method="POST" action="/settings?tab=tokens" style="display:inline;">
                            ...
                            <button type="submit" class="btn btn-outline" style="padding:.3rem .6rem;" title="<?php echo $t['active'] ? 'Deaktivieren' : 'Aktivieren'; ?>">
                                <i class="ti ti-<?php echo $t['active'] ? 'pause' : 'play'; ?>"></i>
                            </button>
                        </form>
                        <form method="POST" action="/settings?tab=tokens" style="display:inline;" onsubmit="return confirm('Token löschen?')">

...
<?php if ($saved): ?>
<div class="alert alert-success"><i class="ti ti-check"></i> Einstellungen gespeichert.</div>
<?php endif; ?>

<form method="POST" action="/notifications">
    <div class="card" style="padding:1.5rem;margin-bottom:1rem;">
        <h3 style="font-size:.88rem;font-weight:600;color:rgba(255,255,255,.9);margin-bottom:1rem;">Benachrichtige mich</h3>
    ...
    <?php
    $channelConfig = [
        'email'    => ['label' => 'E-Mail',    'icon' => 'ti-mail',          'fields' => [['key' => 'address',    'label' => 'E-Mail Adresse', 'type' => 'email']]],
        'discord'  => ['label' => 'Discord',   'icon' => 'ti-brand-discord', 'fields' => [['key' => 'webhook_url','label' => 'Webhook URL',    'type' => 'url']]],
        'telegram' => ['label' => 'Telegram',  'icon' => 'ti-brand-telegram','fields' => [['key' => 'bot_token', 'label' => 'Bot Token',       'type' => 'text'],['key' => 'chat_id','label' => 'Chat ID','type' => 'text']]],
        'ntfy'     => ['label' => 'Ntfy',      'icon' => 'ti-terminal',      'fields' => [['key' => 'url',       'label' => 'Server URL',      'type' => 'url'],['key' => 'topic','label' => 'Topic','type' => 'text']]],
        'gotify'   => ['label' => 'Gotify',    'icon' => 'ti-bell',          'fields' => [['key' => 'url',       'label' => 'Server URL',      'type' => 'url'],['key' => 'token','label' => 'App Token','type' => 'text']]],
        'pushover' => ['label' => 'Pushover',  'icon' => 'ti-device-mobile', 'fields' => [['key' => 'user_key', 'label' => 'User Key',         'type' => 'text'],['key' => 'api_token','label' => 'API Token','type' => 'text']]],
        'webhook'  => ['label' => 'Webhook',   'icon' => 'ti-webhook',       'fields' => [['key' => 'url',       'label' => 'Webhook URL',     'type' => 'url']]],
    ];
        ...
        <div class="card-head" style="cursor:pointer;" onclick="toggleChannel('<?php echo $channel; ?>')">
            ...
            <label style="display:flex;align-items:center;gap:.5rem;cursor:pointer;" onclick="event.stopPropagation()">
                <input type="checkbox" name="enabled[<?php echo $channel; ?>]" value="1"
                    ...
                    style="width:auto;">
                <span style="font-size:.78rem;color:var(--text-muted);"><?php echo $enabled ? 'Aktiv' : 'Inaktiv'; ?></span>
            </label>
        </div>
